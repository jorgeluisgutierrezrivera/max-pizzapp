...
```bash
cd backend && npm test            # 109 pruebas: acceso, carta, regla de precio y pedidos, sin base ni Keycloak reales
...
python pruebas/api/probar_pedidos.py             # crear pedidos: precios, rechazos y la base real
```
