...
| 06 | Pedidos y cola de cocina | El CRUD del pedido (alta con precio del servidor, estados por rol y cancelación con motivo), la cola de cocina y el aviso en vivo mínimo | **En curso** — plan aprobado el 24-sep y revisado el mismo día con la observación de la tutoría (D-36 a D-38) |
